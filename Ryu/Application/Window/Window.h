...
namespace Ryu::Window
{
	...
	public:
		...
		{
			std::pair<i32, i32> WindowSize    = { 1280, 720 };
			std::pair<i32, i32> WindowMinSize = { 800, 600 };
			std::pair<i32, i32> WindowPos     = { CW_USEDEFAULT, CW_USEDEFAULT };
	...
	public:
		...
		[[nodiscard]] inline const std::pair<i32, i32>& GetSize() const noexcept { return m_config.WindowSize; }
		[[nodiscard]] inline const std::pair<i32, i32>& GetPosition() const noexcept { return m_config.WindowPos; }
