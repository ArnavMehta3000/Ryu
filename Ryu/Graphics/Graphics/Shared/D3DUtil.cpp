...
namespace Ryu::Graphics::Utils
{
	...
	Format GetFormat(DXGI_FORMAT format)
	{
		...
		case DXGI_FORMAT_R32G32_UINT:                 return Format::R64_UINT;
		...
		case DXGI_FORMAT_R32G32_SINT:                 return Format::R64_SINT;
		...
		case DXGI_FORMAT_R32_FLOAT_X8X24_TYPELESS:    return Format::R32_FLOAT_X32_TYPELESS;
