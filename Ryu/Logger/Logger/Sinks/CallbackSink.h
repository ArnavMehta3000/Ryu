...
namespace Ryu::Logging
{
	...
	public:
		 ...
		 */
		RYU_API explicit CallbackSink(std::function<void(const LogCategory&, LogLevel, const LogMessage&)> callback);
	...
	private:
		std::function<void(const LogCategory&, LogLevel, const LogMessage&)> m_callback;
	};
}
